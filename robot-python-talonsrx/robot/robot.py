...
class MyRobot(wpilib.TimedRobot):
    ...
    def robotInit(self):
        ...
        print(left_rear_motor.configSelectedFeedbackSensor(
    ...
    def robotPeriodic(self):
        ...
        sd.putNumber("l_encoder_pos", self.l_encoder.getDistance())
        sd.putNumber("l_encoder_rate", self.l_encoder.getRate())
        sd.putNumber("r_encoder_pos", self.r_encoder.getDistance())
        sd.putNumber("r_encoder_rate", self.r_encoder.getRate())
    ...
    def autonomousPeriodic(self):
        ...
        l_encoder_position = self.l_encoder.getDistance()
        l_encoder_rate = self.l_encoder.getRate()

        r_encoder_position = self.r_encoder.getDistance()
        r_encoder_rate = self.r_encoder.getRate()
